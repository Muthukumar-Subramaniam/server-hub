...
ISO_DIR="/iso-files"
MOUNT_DIR="/var/www/${dnsbinder_server_fqdn}/opensuse-leap-latest"
TFTP_DIR="/var/lib/tftpboot/opensuse-leap-latest"
FSTAB="/etc/fstab"
...
rsync -avPh "$MOUNT_DIR/boot/x86_64/loader/linux" "$TFTP_DIR/"
rsync -avPh "$MOUNT_DIR/boot/x86_64/loader/initrd" "$TFTP_DIR/"
