...
ISO_DIR="/iso-files"
MOUNT_DIR="/var/www/${dnsbinder_server_fqdn}/rocky-latest"
TFTP_DIR="/var/lib/tftpboot/rocky-latest"
FSTAB="/etc/fstab"

# 2. Download ISO (skip if already exists)
ISO_FILE="Rocky-10-latest-x86_64-dvd.iso"
ISO_URL="https://dl.rockylinux.org/pub/rocky/10/isos/x86_64/Rocky-10-latest-x86_64-dvd.iso"
