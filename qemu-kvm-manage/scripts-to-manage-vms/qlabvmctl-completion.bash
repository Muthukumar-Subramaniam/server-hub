...
_qlabvmctl_completions() {
    ...
    subcommands="dnsbinder build-golden-image install-golden install-pxe reimage-golden reimage-pxe start stop shutdown restart reboot remove list console resize disk-add disk-attach disk-detach disk-delete nic-add nic-remove version"
