...
fn_show_help() {
    print_notify "Usage: kvm-remove [OPTIONS] [hostname]
...
Examples:
  kvm-remove vm1                    # Remove single VM with confirmation
  kvm-remove -f vm1                 # Remove single VM without confirmation
  kvm-remove --hosts vm1,vm2,vm3    # Remove multiple VMs with confirmation
  kvm-remove -f --hosts vm1,vm2     # Remove multiple VMs without confirmation
