...
Examples:
  kvmlabctl remove vm1                    # Remove single VM with confirmation
  kvmlabctl remove -f vm1                 # Remove single VM without confirmation
  kvmlabctl remove --hosts vm1,vm2,vm3    # Remove multiple VMs with confirmation
  kvmlabctl remove -f --hosts vm1,vm2     # Remove multiple VMs without confirmation
